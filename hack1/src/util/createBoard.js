        ...
        for(let y = 0; y < boardSize; y++){
            if (board[x][y].value != '💣'){
                if (x==0){
                    if(y==0){
                        board[x][y].value = 0
                        if (board[0][1].value == '💣'){board[x][y].value += 1}
                        if (board[1][0].value == '💣'){board[x][y].value += 1}
                        if (board[1][1].value == '💣'){board[x][y].value += 1}
                    }
                    if(y==boardSize-1){
                        board[x][y].value = 0
                        if (board[1][boardSize-1].value == '💣'){board[x][y].value += 1}
                        if (board[0][boardSize-2].value == '💣'){board[x][y].value += 1}
                        if (board[1][boardSize-2].value == '💣'){board[x][y].value += 1}
                    }
                else if (x==boardSize-1){
                    if(y==0){
                        board[x][y].value = 0
                        if (board[boardSize-1][1].value == '💣'){board[x][y].value += 1}
                        if (board[boardSize-2][0].value == '💣'){board[x][y].value += 1}
                        if (board[boardSize-2][1].value == '💣'){board[x][y].value += 1}
                    }
                    if(y==boardSize-1){
                        board[x][y].value = 0
                        if (board[boardSize-2][boardSize-1].value == '💣'){board[x][y].value += 1}
                        if (board[boardSize-1][boardSize-2].value == '💣'){board[x][y].value += 1}
                        if (board[boardSize-2][boardSize-2].value == '💣'){board[x][y].value += 1}
                    }
                }
                else {
